...
class ApWifiMac : public WifiMac
{
  ...
  private:
    ...
    void HandleAuthenticationRequest(Ptr<const Packet> packet, Mac48Address clientAddress, u_int8_t linkId);

    void SendAuthenticationResponse(uint16_t authAlgorithm, Mac48Address clientAddress, StatusCode statusCode, uint8_t seqNumber,  u_int8_t linkId);
    /**
